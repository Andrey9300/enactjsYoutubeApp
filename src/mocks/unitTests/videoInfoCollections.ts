...
const title = [
  'Ледокол',
  '1812. Серия 1',
  'Воскресший Эртугрул. Сезон 1. Серия 1',
  'Пламя и Цитрон',
  'Барбаросса. Серия 1',
  'Чернобыль. Сезон 1. Серия 1',
  'Марко Поло. Сезон 1. Серия 1',
  'Дело Декабристов. Серия 1',
];

const description = [
  'Однажды утром Смешарики просыпаются и понимают, что они все стали белого цвета. Лосяш пытается придумать',
